                ...
                <div className="container flex justify-around h-16 mx-auto">
                    ...
                    <label for="Toggle2" className="inline-flex items-center space-x-4 cursor-pointer dark:text-gray-100">
                        <span className="relative">
                            ...
                            <div className="w-10 h-4 rounded-full shadow dark:bg-gray-600 peer-checked:dark:bg-yellow-400"></div>
                            <div className="absolute left-0 w-6 h-6 rounded-full shadow -inset-y-1 peer-checked:right-0 peer-checked:left-auto dark:bg-yellow-500"></div>
                        </span>
                    </label>
                </div>
            </header>
